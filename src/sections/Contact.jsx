...
export default function Contact() {
  ...
  // Validation : WhatsApp n'est plus obligatoire
  const validateForm = () => {
    const newErrors = {};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 pt-10">
          <div className="space-y-8">
            <div className="space-y-4">
             <h3 className="text-2xl font-semibold">{t("contact_me_left")}</h3>
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href={`tel:${phone}`} className="hover:text-blue-400 transition">
                    {phone}
                  </a>
                </div>
                <div className="flex items-center gap-3">
            ...
            <div>
             <h4 className="text-lg font-medium mb-4">{t("find_me_on")}</h4>
              <div className="flex gap-4">
                <a href={socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 hover:bg-blue-600/20 transition-all duration-300 hover:scale-110">
                ...
                <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 hover:bg-blue-600/20 transition-all duration-300 hover:scale-110">
                ...
                <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 hover:bg-blue-600/20 transition-all duration-300 hover:scale-110">
                ...
                <a href={socialLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 hover:bg-blue-600/20 transition-all duration-300 hover:scale-110">
          ...
          <div className="bg-gray-100 dark:bg-[#1A1A1E] rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
            <div
              className="bg-gradient-to-r from-blue-800 to-blue-600 p-3 cursor-pointer flex items-center justify-between"
                ...
                {step === "form" ? (
                  <div className="flex-1 p-4 space-y-3">
                    <input
                      ...
                      className="w-full p-2.5 rounded-xl bg-white dark:bg-[#2A2A2E] border border-gray-300 dark:border-gray-700 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none"
                    />
                    ...
                    <button
                      ...
                      disabled={isSending}
                      className="w-full bg-gradient-to-r from-blue-800 to-blue-600 text-white font-bold py-2.5 rounded-xl disabled:opacity-50"
                    >
                  ...
                  <>
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-1">
                        {quickQuestions.map((q, idx) => (
                          <button
                            ...
                            className="text-[10px] bg-gray-200 dark:bg-[#2A2A2E] px-2 py-1 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/30 transition"
                          >
                            {t(q.textKey)}
                          </button>
                        ))}
                    ...
                    <div className="p-3 border-t border-gray-200 dark:border-gray-800 flex gap-2">
                      <input
                        ...
                        className="flex-1 text-xs p-2 rounded-xl bg-white dark:bg-[#2A2A2E] border border-gray-300 dark:border-gray-700 focus:border-blue-500 outline-none"
                      />
                      <button
                        onClick={handleSendMessage}
                        className="bg-gradient-to-r from-blue-800 to-blue-600 text-white px-3 rounded-xl text-sm font-medium"
                      >
                        Envoyer
                      </button>
                    </div>
